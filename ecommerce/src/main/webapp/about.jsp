		...
		<div class="container">	
			<div class="w3ls_about_grids">
				<div class="col-md-6 w3ls_about_grid_left">
					<p>HoMera is an Indian company based in Bhubaneswar, Odisha, India.
					We believe in providing quality products and services with assurance. </p>
					...
					<div class="col-xs-10 w3ls_about_grid_left2">
						<p>We as a team collaborated to make a better world by understanding 
						and fulfilling our customer needs.</p>
					</div>  
					...
					<div class="col-xs-10 w3ls_about_grid_left2">
						<p> We provide home delivery and return policy on a ordered 
						product of our customer with complete safety.</p>
					</div>
					<div class="clearfix"> </div>
				</div>
	...
	<div class="newsletter">
		<div class="container">
			<div class="col-md-6 w3agile_newsletter_left">
				<h3>Newsletter</h3>
				<p>Get to know anything about new offers, products and services.</p>
			</div>
